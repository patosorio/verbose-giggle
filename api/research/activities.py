...
def _research_prompt(
    *,
    ...
    return (
        ...
        "- Do not recommend a venue, tour, or activity if a source indicates it has permanently closed, "
        "is no longer operating, or hasn't been mentioned in any source less than ~2 years old — prefer "
        "sources with a recent, clear indication the business is currently active over older or "
        "ambiguous ones.\n"
